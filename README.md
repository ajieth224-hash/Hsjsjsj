...
```js
{
    "captchaAPI": "captchaly", // Options: "captchaly", "yescaptcha"
...
```js
{
    ...
    "prefix": "!",
    "captchaAPI": "captchaly",
    "apiKey": "your-captchaly-api-key",
    "autoHuntbot": true,
...
A: Both Captchaly and yescaptcha work well. Choose based on pricing and availability in your region.
...
- `captchaAPI` is set to "captchaly" or "yescaptcha"
...
💫 We are BKI members (Baka Island - Đảo Ngố Tàu)# Hsjsjsj
